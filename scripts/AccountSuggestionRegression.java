...
public class AccountSuggestionRegression {
  public static void main(String[] args)throws Exception {
    ...
    var service=new AppAccountService(db,null,null);
    ...
    try {
      for(int i=0;i<30;i++)jobs.add(pool.submit(()->tx.execute(s->new AppAccountService(db,null,null).suggestAccount())));
    ...
    if(!tx.execute(s->new AppAccountService(db,null,null).suggestAccount()).equals(day+"101"))throw new AssertionError("restart lost counter");
