<template>
  <section class="thinking-panel" :class="{'is-open':open}">
...
<style scoped>
.thinking-panel:not(.is-open) .thinking-toggle{border-bottom:0;padding-bottom:0}
...
.thinking-content{box-sizing:border-box;width:100%;min-width:0;max-height:138px;overflow:auto;margin-top:8px;padding:2px 1px 4px;color:#747f94;font-size:12px;line-height:1.65;overflow-wrap:anywhere;word-break:break-word}
