...
.message.assistant{flex-direction:column;align-items:flex-start}.has-thinking{min-width:0}.thinking-panel+.markdown-content{margin-top:10px;padding-top:10px;border-top:1px solid #edf0f5}.notify>.thinking-panel{margin-bottom:11px;padding-bottom:10px;border-bottom:1px solid #edf0f5}
