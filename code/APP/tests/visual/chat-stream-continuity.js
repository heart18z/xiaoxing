...
async page => {
 ...
 await page.screenshot({path:'output/playwright/mobile120-thinking.png'});
 ...
 const final=await bottom();await page.screenshot({path:'output/playwright/mobile120-reply.png'});
