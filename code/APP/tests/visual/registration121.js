async page => {
 ...
 const inputs=form.locator('input');await inputs.nth(0).fill('fixture_user');await inputs.nth(1).fill('测试注册');await inputs.nth(2).fill('FixturePassword123');await inputs.nth(4).fill('fixture@example.com');
