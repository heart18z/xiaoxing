...
import org.springblade.modules.auth.handler.BladeRedisLockHandler;
...
public class BladeAuthConfiguration {
	...
	public AuthorizationHandler authorizationHandler(BladeProperties bladeProperties,
													   ...
													   BladeRedisLockHandler lockHandler,
													   IUserService userService) {
		return new BladeAuthorizationHandler(bladeProperties, tenantProperties, oAuth2Properties, lockHandler, userService);
	}
